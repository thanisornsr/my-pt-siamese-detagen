...
class Pt_datagen_siamese:
	...
	def shuffle_order(self):
		...
		to_shuffle = list(zip(temp_imgsA,temp_imgsA_bbox,temp_imgsB,temp_imgsB_bbox,temp_y))
		random.shuffle(to_shuffle)
		temp_imgsA,temp_imgsA_bbox,temp_imgsB,temp_imgsB_bbox,temp_y = zip(*to_shuffle)
